      ...
      <main className="flex flex-col flex-1 pt-28 pb-16 px-6 md:px-12">
        <div className="max-w-xl mx-auto w-full">
          ...
          <div className="mb-12">
            ...
            >
              {isShipping ? "On its way." : "Ready soon."}
            </h1>
            <p
          ...
          <div className="space-y-5 mb-10">
            ...
            <Row label="Fulfillment" value={isShipping ? "Ship to Address" : "Local Pickup"} />
            ...
            <div>
              ...
              >
                <div>
                  ...
                  <p
                    className="text-sm text-[#999] leading-6"
                    style={{ fontFamily: "var(--font-sans)" }}
                  >
                    {/* TODO: Replace with mosque address */}
                    Address to be provided by MCWS.
                  </p>
                </div>
                <div>
                  <p
                  ...
                  <p
                    ...
                    style={{ fontFamily: "var(--font-sans)" }}
                  >
                    You will be notified by email when your order is ready for
                    pickup. Please bring your order confirmation email.
                  </p>
                </div>
              </div>
            </div>
