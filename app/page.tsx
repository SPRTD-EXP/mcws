...
function CommunityTeaser() {
  return (
    <section className="px-6 py-24 md:px-12 md:py-32 pattern-overlay">
      <div className="max-w-2xl mx-auto text-center">
        <p
          className="text-[#999] text-xs tracking-[0.3em] uppercase mb-6"
        ...
        <p
          className="text-[#999] text-sm leading-7 mb-10 max-w-lg mx-auto"
          style={{ fontFamily: "var(--font-sans)" }}
        >
